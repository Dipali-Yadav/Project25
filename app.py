...
st.set_page_config(page_title="IntelliTravel - Hotel Recommendation System", layout="wide",
...
options = ["Home", "Find Similar Hotels", "Search Hotels by City, Star Rating, and Feature",
"Check Out Attractions", "Contact Us"]
...
At IntelliTravel, we help you find the best hotels that match your preferences. Whether
you're looking for a hotel similar to one you've stayed at before or searching for a new
experience in a different city, we've got you covered.
### Our Features:
- **Find Similar Hotels**: Discover hotels similar to the ones you love.
- **Search Hotels by City, Star Rating, and Feature**: Tailor your search to find the perfect
stay.
...
st.markdown(
"Liked a hotel you stayed in? Find out similar hotels in your destination city. Our
recommendation engine will suggest you the best hotel for your best experience."
)
...
{'<p><strong>Nearby Attractions:</strong> ' + attractions_summary + '</p>' if
attractions_summary else ""}
<a
href="https://www.google.com/search?q={row['property_name']}+{target_city}"
...
st.markdown(
"Looking for the perfect hotel? Search by city, minimum star rating, and desired features to
find the best options for your stay."
)
...
{'<p><strong>Nearby Attractions:</strong> ' + attractions_summary + '</p>' if
attractions_summary else ''}
<a href="https://www.google.com/search?q={row['property_name']} {city}"
target="_blank">Book</a>
</div>
</div>
""",
...
st.write(f"No hotels found in {city} with a minimum star rating of {star_rating} and features
'{feature}'.")
# Check Out Attractions
elif choice == "Check Out Attractions":
st.title("Check Out Attractions")
st.markdown("Enter your hotel name and city to find nearby attractions. Discover what you
can explore near your stay.")
...
- **Email**: [yadavdipaliy20@gmail.com](mailto:yadavdipaliy20@gmail.com)
"""
)